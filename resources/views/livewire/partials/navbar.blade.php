  ...
  <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        ...
        <a class="flex items-center space-x-2 text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" 
        href="/" 
        aria-label="Brand">
          <img src="{{asset('images/spartan.png')}}" alt="logo" class="h-12 w-12">
          <span class="whitespace-nowrap">Spartan Commerce</span>
        </a>        
     <div class="md:hidden">

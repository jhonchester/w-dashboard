  ...
  <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      ...
      <div class="col-span-2">
        ...
        <p class="mt-4 text-sm text-gray-400 dark:text-gray-300 text-justify">
          Thank you for visiting our web app! Keep using Spartan Commerce, and we'll keep you updated with the latest news and offers.
          If you have any questions, feel free to reach out. in <a href="mailto:spartancommerce@gmail.com" class="text-blue-500 underline">spartancommerce@gmail.com</a>
        </p>
